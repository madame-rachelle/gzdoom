...
void A_BetaSkullAttack(mobj_s *actor)
{
  int damage;
...
void A_OpenShotgun2(player_s *player, pspdef_t *psp)
{
  S_StartSound(player->mo, sfx_dbopn);
}

void A_LoadShotgun2(player_s *player, pspdef_t *psp)
{
  S_StartSound(player->mo, sfx_dbload);
}

void A_CloseShotgun2(player_s *player, pspdef_t *psp)
{
