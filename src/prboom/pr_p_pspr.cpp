...
void A_CheckReload(player_s *player, pspdef_t *psp)
{
...
void A_Punch(player_s *player, pspdef_t *psp)
{
  angle_t angle;
  int t, slope, damage;
...
void A_Saw(player_s *player, pspdef_t *psp)
{
  int slope, damage;
  angle_t angle;
  int t;
...
void A_FireMissile(player_s *player, pspdef_t *psp)
{
...
void A_FireBFG(player_s *player, pspdef_t *psp)
{
...
void A_FireOldBFG(player_s *player, pspdef_t *psp)
{
  int type = MT_PLASMA1;
...
void A_FirePlasma(player_s *player, pspdef_t *psp)
{
...
void A_FirePistol(player_s *player, pspdef_t *psp)
{
...
void A_FireShotgun(player_s *player, pspdef_t *psp)
{
  int i;
...
void A_FireShotgun2(player_s *player, pspdef_t *psp)
{
  int i;
...
void A_FireCGun(player_s *player, pspdef_t *psp)
{
...
void A_BFGsound(player_s *player, pspdef_t *psp)
{
