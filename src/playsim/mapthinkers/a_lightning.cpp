...
void DLightningThinker::Construct()
{
	...
	NextLightningFlash = ((pr_lightning()&15)+5)*GameTicRate; // don't flash at level start
...
void DLightningThinker::LightningFlash ()
{
	...
	if (!NextLightningFlash)
	{
		...
		else
		{
			...
			{
				NextLightningFlash = ((pr_lightning()&7)+2)*GameTicRate;
			}
			else
			{
				NextLightningFlash = ((pr_lightning()&15)+5)*GameTicRate;
			}
		}
	}
}
